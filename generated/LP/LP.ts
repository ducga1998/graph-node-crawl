...
export class LP__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class LP extends ethereum.SmartContract {
  ...
  burn(to: Address): LP__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new LP__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<LP__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new LP__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): LP__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new LP__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<LP__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
