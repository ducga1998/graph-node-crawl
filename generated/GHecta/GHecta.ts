...
export class GHecta__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GHecta extends ethereum.SmartContract {
  static bind(address: Address): GHecta {
    return new GHecta("GHecta", address);
  }
  ...
  approved(): Address {
    let result = super.call("approved", "approved():(address)", []);

    return result[0].toAddress();
  }

  try_approved(): ethereum.CallResult<Address> {
    let result = super.tryCall("approved", "approved():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  balanceFrom(_amount: BigInt): BigInt {
    let result = super.call("balanceFrom", "balanceFrom(uint256):(uint256)", [
  ...
  balanceTo(_amount: BigInt): BigInt {
    let result = super.call("balanceTo", "balanceTo(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_amount)
    ]);
  ...
  try_balanceTo(_amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("balanceTo", "balanceTo(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_amount)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  checkpoints(param0: Address, param1: BigInt): GHecta__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new GHecta__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<GHecta__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint256):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GHecta__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  sHECTA(): Address {
    let result = super.call("sHECTA", "sHECTA():(address)", []);

    return result[0].toAddress();
  }

  try_sHECTA(): ethereum.CallResult<Address> {
    let result = super.tryCall("sHECTA", "sHECTA():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
